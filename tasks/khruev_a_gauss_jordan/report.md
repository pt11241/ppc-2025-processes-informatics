...
Результаты измерения производительности для матриц размером $200 * 200$:

#### Время выполнения 
Режим	|Процессы|	Время, c	|Ускорение	|Эффективность
---|---|---|---|---|
seq	|1	|0.0032201290|1.00	|100%
mpi	|2	|0.0017732698|1.81	|91%
mpi	|3	|0.0015653760|2,06	|68%
mpi	|4	|0.0014831233|2.17	|54%

Из таблицы можно видеть, что mpi реализация дает довольно хороший прирост производительности.
