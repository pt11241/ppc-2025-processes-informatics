...
class KhruevARunFuncTestsProcesses
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<KhruevAGaussJordanMPI, InType>(
        kTestParam, PPC_SETTINGS_khruev_a_gauss_jordan),
    ppc::util::AddFuncTask<KhruevAGaussJordanSEQ, InType>(
        kTestParam, PPC_SETTINGS_khruev_a_gauss_jordan));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName =
    KhruevARunFuncTestsProcesses::PrintFuncTestName<
        KhruevARunFuncTestsProcesses>;
